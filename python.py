...
prihlaseni = input("zadej jmeno: ")

if prihlaseni in uzivatele:
    print("vitej! ", prihlaseni)
    print("vitej v nasem filmovem slovniku".upper().center(62),
          oddelovac, sep="\n")
    print("| ".join(sluzby) + "|".center(62),oddelovac,sep="\n")
else:
    print("neznamy uzivatel. ")
...
if vyber in sluzby and vyber == "dostupne filmy":
    ...
    print(oddelovac,"FILM: "+ film, filmy.get(film,"Tento film neni v nabidce"), oddelovac, sep="\n")
